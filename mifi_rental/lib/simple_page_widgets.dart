...
import 'db/db_person.dart';

class FirstRouteWidget extends StatelessWidget {
  testQuery() async {
    var tp = PersonDb();
    var list = await tp.queryAll();
    await tp.insert(Person(firstName: "z", lastName: "qc"));
  }
...
//                });
//                NetClient().post(
//                    "http://58.251.37.197:10208/bss/app/noauth/CheckSocialUser",
//                    params: {"streamNo": "213123asdasdad"},
//                    error: (e) {
//                      var a=e;
//                    });
                testQuery();
