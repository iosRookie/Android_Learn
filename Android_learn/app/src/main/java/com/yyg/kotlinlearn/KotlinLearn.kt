...
class KotlinLearn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainlist.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            ...
            if (listItems[position] == "基本数据类型") {
                val intent = Intent(this, BasicDataTypeActivity::class.java)
                startActivity(intent)
            }
            if (listItems[position] == "条件控制") {
                val intent = Intent(this, ConditionControlActivity::class.java)
                startActivity(intent)
            }
            if (listItems[position] == "循环控制") {
                val intent = Intent(this, CycleControlActivity::class.java)
                startActivity(intent)
            }
            if (listItems[position] == "类和对象") {
                val intent = Intent(this, ClassAndObjectActivity::class.java)
                startActivity(intent)
            }
            if (listItems[position] == "继承") {
                val intent = Intent(this, InheritActivity::class.java)
                startActivity(intent)
            }
            ...
            if (listItems[position] == "扩展") {
                val intent = Intent(this, ExtensionAvtivity::class.java)
                startActivity(intent)
            }
            if (listItems[position] == "数据类与密封类") {
                val intent = Intent(this, DataAndSealedActivity::class.java)
                startActivity(intent)
            }
            ...
            if (listItems[position] == "枚举类") {
                val intent = Intent(this, EnumClassActivity::class.java)
                startActivity(intent)
            }
